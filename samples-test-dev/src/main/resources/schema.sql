DROP TABLE IF EXITS Movement;
DROP TABLE IF EXITS IncomesExpenses;
DROP TABLE IF EXITS Invoice;
DROP TABLE IF EXITS Agreement;
DROP TABLE IF EXITS Sponsor;
DROP TABLE IF EXITS Event;
DROP TABLE IF EXITS Type;
DROP TABLE IF EXITS GbMember;
DROP TABLE IF EXITS SpContact;
DROP TABLE IF EXITS LevelOfSponsorship;
