...
-- Create the GBMember table if it doesn't exist
...
-- Create the Sponsorship table if it doesn't exist
...
CREATE TABLE IF NOT EXISTS Invoice (
    ...
    vat                REAL NOT NULL,
    invoice_amount     REAL NOT NULL,  -- Regular column, not generated
    sent_date          DATE,
